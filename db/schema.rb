...
ActiveRecord::Schema.define(version: 2019_12_10_175335) do
  ...
  create_table "addon_prices", force: :cascade do |t|
    t.float "daily_rate"
    t.integer "subsidiary_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "addon_id"
    t.index ["addon_id"], name: "index_addon_prices_on_addon_id"
    t.index ["subsidiary_id"], name: "index_addon_prices_on_subsidiary_id"
  end
